...
ActiveRecord::Schema.define(version: 2020_04_02_151511) do
  ...
  create_table "scores", force: :cascade do |t|
    ...
    t.index ["user_id", "movie_id"], name: "index_scores_on_user_id_and_movie_id", unique: true
  ...
  add_foreign_key "scores", "movies", on_delete: :cascade
